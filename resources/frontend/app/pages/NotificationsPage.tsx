                        ...
                        <p className="text-gray-500 font-['Manrope'] text-[15px]">
                            {isLoading
                                ...
                                : unreadCount > 0
                                  ...
                                  : "Seluruh sistem sudah kamu cek hari ini."}
                        </p>
                    </div>
                    {unreadCount > 0 && (
                        <button
                ...
                <div className="px-6 pt-6 pb-2">
                    <div className="flex gap-2">
                        ...
                        >
                            ...
                            {unreadCount > 0 && (
                                <span
                                    className={`w-5 h-5 flex items-center justify-center rounded-full text-[10px] ${filter === "unread" ? "bg-white/20 text-white" : "bg-primary/10 text-primary"}`}
                                >
                                    {unreadCount}
                                </span>
                            )}
                                ...
                                {displayedNotifications.map((notif, index) => (
                                    ...
                                    >
                                        <div className="flex gap-4 sm:gap-5 relative z-10">
                                            {/* Icon Container */}
                                            <div
                                                className={`w-[52px] h-[52px] shrink-0 rounded-2xl flex items-center justify-center border transition-transform group-hover:scale-110 duration-300 ${getNotificationBg(notif.type)} shadow-inner`}
                                            >
                                                {getNotificationIcon(
                                                    notif.type,
                                                )}
